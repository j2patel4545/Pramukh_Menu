...
function Feedback() {
    ...
    const templateID = 'template_8hu1qqi';
    const publicKey = '7HkubMX2gMl3wRRMX';
    ...
    return (
        <div className='w-screen py-10 pt-2 bg-[#222222] px-[6%]'>
            <div className="bg-white border border-slate-200 grid grid-cols-6 gap-2 rounded-xl p-2 text-sm">
                ...
                ></textarea>
                <button
                    className={`fill-slate-600 col-span-1 flex justify-center items-center rounded-lg p-2 duration-300 bg-slate-100 hover:border-slate-600 ${like ? 'bg-blue-400 text-white' : ''}`}
                    onClick={() => { setLike(true); setDislike(false); }}
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        height="20px"
                        viewBox="0 0 512 512"
                        fill={like ? "green" : "currentColor"}  // Change fill color dynamically
                    >
                ...
                <button
                    className="fill-slate-600 col-span-1 flex justify-center items-center rounded-lg p-2 duration-300 bg-slate-100 hover:border-slate-600"
                    onClick={() => {
                        setDislike(true);
                        setLike(false);
                    }}
                >
                    <div >
                        <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 0 512 512"  fill={dislike ? "green" : "currentColor"} >
